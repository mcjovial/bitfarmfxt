...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Bitfarmfxt is an Investment firm that generates passive incomes for her potential 
    Investors, we offer Crypto, Blockchain and forex related investment services.">
    <meta name="keywords" lang="en" content="stock exchanges, cryptocurrency, forex, bitcoin, investment, ethereum, markets, Bitfarmfxt, crypto-investment">
    <meta property="og:url"                content="index.html" />
    <meta property="og:type"               content="Organization" />
    <meta property="og:title"              content="Bitfarmfxt Investment Firm" />
    <meta property="og:description"        content="Bitfarmfxt is an Investment firm that generates passive incomes for her potential Investors, we offer Crypto, Blockchain and forex related investment services." />
    <meta property="og:image"              content="../i.ibb.co/09t77QX/tradeon.jpg" />
    <meta name="viewport" content="user-scalable=no, width=device-width, initial-scale=1">
    <meta name="generator" content="Bitfarmfxt company developer">
    ...
    <meta name="apple-mobile-web-app-capable" content="Bitfarmfxt">
...
<script type="application/ld+json">    
{
  ...
  "@type": "organization",
  "name": "Bitfarmfxt",
  "url": "http://www.Bitfarmfxt.org",
  "sameAs": [
    "http://instagram.com/Bitfarmfxt.investments"
  ]
}
</script>

<!--<span itemscope itemtype="https://schema.org/Organization">-->
<!--  <link itemprop="url" href="http://www.Bitfarmfxt.com">-->
<!--  <a itemprop="sameAs" href="http://www.instagram.com/Bitfarmfxt.investments">FB</a>-->
<!--</span>-->
<body>
...
<header class="header navbar fixed-top navbar-expand-lg">
    <div class="container">
        ...
        <a class="navbar-brand logo" href="{{route('home')}}">
            <!--<img src="/img/shortlog-light.png" class="hide first" alt="Bitfarmfxt"> -->
            <img src="{{url('/')}}/asset/{{$logo->image_link}}" class="last" width="125" alt="Bitfarmfxt"/>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="footer__logo widthper text-left-md">
                    ...
                    <p style="line-height: 1.5;margin-bottom: .8rem;"><i class="ti-email"></i>&nbsp; support@Bitfarmfxt.org</p>
                    <a href="https://www.instagram.com/Bitfarmfxt.investments"><i class="ti-instagram"></i>
                    ...
                    <!--<a href="https://www.instagram.com/Bitfarmfxt.investments"><i class="ti-facebook"></i></a>-->
                    <!--<a href="https://www.instagram.com/Bitfarmfxt.investments"><i class="ti-youtube"></i></a>-->
                </div>
            </div>
            <div class="col-md-3 ">
                <div class="foot_link">
            ...
            <div class="col-md-4 text-left-md text-center">
                <small>© 2021 Bitfarmfxt. All rights reserved. </small>
            </div>
...
<script type="text/javascript">
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/61e7cf7bf7cf527e84d2e607/default';
    s1.charset='UTF-8';
...
<!-- Mirrored from www.Bitfarmfxt.org/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Jan 2022 10:44:18 GMT -->
</html>
