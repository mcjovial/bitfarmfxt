                    ...
                    <div class="formo">
                            ...
                            <form action="{{route('submitregister')}}" class="form" method="POST" >
                                ...
                                <div class="section-container">
                                        ...
                                        <div class="form-group mb10">
                                            <div class="form-group__container">
                                                <input type="text" name="ref" class="form-control" placeholder="Referral Id - Optional" value="{{ request()->ref }}">
                                            </div>
                                        </div>
                        ...
                        <div class="sucRegister">
                            <div class="sucRegister_first">
                                <div class="sucRegister__body">
                                    ...
                                    <div class="text text-center">
                                        Welcome to Bitfarmfxt!, <strong>Thanks</strong> for Joining us. A verification link has just been sent to
                            ...
                            <div class="text-center lastskip" id="skip" style="font-weight: ;margin-top: 2rem;">
                                <a href="{{route('login')}}" style="font-weight: 700;">Navigate to Dashboard</a>
                            </div>
                        </div>
